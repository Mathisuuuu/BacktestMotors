...
- [[reference/independance-des-essais]] — **pourquoi le seuil de deflation s'effondre quand on archive des essais voisins** : le seuil est un PRODUIT `sqrt(V) x f(N)`, et c'est `sqrt(V)` qui tombe de 78 %, pas le compte qui fauterait. 462 essais sur 498 sur le meme echantillon. `rsl essais --familles`.
